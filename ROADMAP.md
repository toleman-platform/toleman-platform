...
<!-- Probe (delete with this branch): one-file PR used to verify #429's diff
     attribution against the deployed backend. Before that change, a PR this
     shape was told it introduced findings in files it never touched. -->
