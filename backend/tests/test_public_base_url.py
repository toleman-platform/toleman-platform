...
def test_extra_origins_ignores_blanks_and_duplicates():
    s = _settings(
        public_base_url="https://toleman.example.com",
        extra_cors_origins=" , https://toleman.example.com/ ,, https://other.example.com ",
    )
    assert s.cors_allow_origins == ["https://toleman.example.com", "https://other.example.com"]
...
def test_wildcard_is_never_produced():
    ...
    s = _settings(public_base_url="https://toleman.example.com", extra_cors_origins="https://a.example.com")
