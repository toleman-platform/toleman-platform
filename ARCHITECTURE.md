...
| `targets` | `/api/targets` | login, workspace-scoped reads | repo CRUD, pipeline integration (`/{id}/pipeline-workflow` generate, `/{id}/pipeline-integrate` opens a real PR, #66) |
