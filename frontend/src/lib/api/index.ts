...
export const api = {
  ...
  raiseFixPr: findings.raiseFixPr,
  raisePackageFixPr: findings.raisePackageFixPr,
  raiseAllFixPrs: findings.raiseAllFixPrs,
  getRaiseAllFixPrsBatch: findings.getRaiseAllFixPrsBatch,
  ...
  getPrGuardrailScan: scans.getPrGuardrailScan,
  ...
  getIgnoreRequestHistory: scans.getIgnoreRequestHistory,
  ...
  deleteGithubApp: admin.deleteGithubApp,
  auditLog: admin.auditLog,
  auditActors: admin.auditActors,
  securityAuditLog: admin.securityAuditLog,
  securityAuditActors: admin.securityAuditActors,
